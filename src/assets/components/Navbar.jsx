  ...
  return (
    <div className="flex justify-between px-4 md:px-12 py-3 w-screen">
      ...
      <div className="flex gap-3 md:w-100">
        <input value={SearchData} onChange={(e) => setSearchData(e.target.value)} type="text" placeholder="Search Movie" className="w-36 md:w-auto md:px-2 border focus:outline-none border-red-600 rounded-xl"/>
